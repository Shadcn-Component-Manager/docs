...
# Metadata Format (registry.json)

Each component in the SCM registry must include a `registry.json` file describing its metadata, dependencies, and other important information.
